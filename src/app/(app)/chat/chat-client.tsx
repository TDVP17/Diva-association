  ...
  if (active) {
    return (
      <div className="flex flex-col h-[calc(100vh-64px)] bg-background">
        <div className="flex items-center gap-3 px-4 py-3 bg-white shadow-sm border-b border-surface-container z-10 sticky top-0">
          <button
          ...
          <div className="w-10 h-10 rounded-full bg-surface-container-high text-primary flex items-center justify-center font-title-md text-title-md overflow-hidden">
            {active.avatar ? (
          ...
          <h2 className="font-label-md text-label-md font-bold text-on-surface">{active.name}</h2>
        </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-label-sm text-label-sm text-on-surface-variant">
                    Position exchange requested &middot; {TONTINE_LABELS[item.tontineType] ?? item.tontineType}
                  </p>
                </div>
                <span className="font-label-sm text-label-sm px-2 py-0.5 rounded-full bg-secondary-fixed-dim/20 text-on-secondary-fixed-variant">
                  {item.status === "PENDING_MEMBERSHIP" && "Awaiting your response"}
                  {item.status === "PENDING_ADMIN" && "Pending admin approval"}
        ...
        <div className="bg-white p-3 border-t border-surface-container shadow-[0px_-4px_20px_rgba(30,41,59,0.05)] sticky bottom-0 z-10 w-full">
          {primarySwap && (
            <div className="mb-3 flex justify-center">
              ...
              >
                ...
                Request Exchange (Pos #{primarySwap.myPosition ?? "?"} &harr; #{primarySwap.theirPosition ?? "?"})
              </button>
            </div>
          )}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex justify-between items-baseline mb-1">
                <h3 className="font-title-md text-title-md text-on-surface truncate font-semibold">{contact.name}</h3>
              ...
              <p className="font-body-md text-body-md text-on-surface-variant truncate">
                {contact.lastMessagePreview ?? "Say hello!"}
              </p>
            </div>
          </button>
        ))}
