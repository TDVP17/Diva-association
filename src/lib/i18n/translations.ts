...
export const translations = {
  en: {
    ...
    identityVerificationBody:
      "To join this cotisation, we need to verify your identity. Upload a photo of your ID document and a selfie — an admin will review them and approve your request.",
  ...
  fr: {
    ...
    identityVerificationBody:
      "Pour rejoindre cette cotisation, nous devons vérifier votre identité. Téléversez une photo de votre pièce d'identité et un selfie — un admin les examinera et approuvera votre demande.",
