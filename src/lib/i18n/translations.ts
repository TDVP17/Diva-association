...
export const translations = {
  en: {
    ...
    startsOn: "Starts",
    sessionStatusDraft: "Waiting for draw",
    ...
    estimatedDateLabel: "Expected",
    positionNotYetAssignedShort: "Position not yet assigned",
    ...
    payoutClaimStatusSubmitted: "Details submitted",
    payoutClaimStatusReleased: "Released",
    payoutClaimStatusConfirmed: "Confirmed",
    ...
    title: "Title",
    sessionTitlePlaceholder: "e.g. Sunday Cycle — Douala Team",
    frequency: "How often?",
    ...
    noBackSideSubmitted: "No back side submitted",
    ...
    orangeMoneyLabel: "Orange Money",
    mtnMobileMoneyLabel: "MTN Mobile Money",
    defaultPayerLabel: "Default",
    useNewPayerNumberAction: "Use a different number",
    savePayerNumberAction: "Save this number for future payments",
    unrecognizedMobileMoneyProvider: "This number doesn't match a known Orange Money or MTN Mobile Money range.",
    savedPaymentMethodLimitReached: "You can save up to {max} payer numbers.",
    savedPaymentMethodDuplicate: "This number is already saved.",
    savedPayerNumbersTitle: "Saved Payer Numbers",
    savedPayerNumbersBody: "Save Orange Money or MTN Mobile Money numbers here to reuse them when you contribute — only visible to you.",
    payerNumberSaved: "Payer number saved.",
    setAsDefaultAction: "Set as default",
    removePayerNumberAction: "Remove this payer number",
    addPayerNumberAction: "Add",
    ...
    swapCannotRequestSelf: "You cannot request a swap with yourself.",
    swapMembersMustBelong: "Both members must belong to this cotisation.",
    swapAlreadyPending: "There is already a pending swap request between you two.",
    swapRequestNotFound: "This swap request no longer exists.",
    swapOnlyTargetCanRespond: "Only the requested member can respond to this request.",
    swapAlreadyResolved: "This request has already been resolved.",
    ...
    paymentReceivedEmailSubject: "Payment received — {session}",
    paymentSentEmailSubject: "Payment sent — {session}",
    paymentReceivedEmailGreeting: "Hello {name},",
    paymentReceivedEmailIntro: "🎉 Your contribution has been received successfully.",
    thankYouContributionLine: "Thank you for your contribution to the community fund.",
    ...
    documentTypeSelectionLabel: "Which document would you like to use?",
    documentTypeCni: "CNI (Carte Nationale d'Identité)",
    documentTypeRecepisse: "Récépissé",
    cniBothSidesRequired: "Both sides of the ID card are required.",
    recepisseSingleSideNote: "The front is required. The back is optional for a Récépissé.",
    documentFrontPhotoLabel: "Front of your CNI",
    documentFrontPhotoInstruction: "Take a clear, well-lit photo of the front of your CNI. All text must be readable.",
    documentFrontPhotoLabelRecepisse: "Front of your Récépissé",
    documentFrontPhotoInstructionRecepisse: "Take a clear, well-lit photo of the front of your Récépissé. All text must be readable.",
    documentBackPhotoLabel: "Back of your CNI",
    documentBackPhotoInstruction: "Now the back of the same CNI.",
    documentBackPhotoLabelRecepisse: "Back of your Récépissé (optional)",
    documentBackPhotoInstructionRecepisse: "If your Récépissé has a printed back side, add it here — otherwise you can skip this.",
    selfiePhotoLabel: "A selfie of yourself",
    selfiePhotoInstruction: "Take a clear photo of your own face — good lighting, no sunglasses or mask, looking straight at the camera. This must be you, not a photo of the ID.",
    kycSubmissionSummary: "Ready to submit: front + back of your CNI, a selfie, and referrer {referrer}. An admin will review everything before approving your request.",
    ...
    kycSessionLookupFailed: "Could not load this cotisation's details. Please check your connection and try again.",
    kycMembershipCheckFailed: "Could not check your membership status. Please check your connection and try again.",
    kycTransactionFailed: "Your photos uploaded, but the submission could not be saved. Please try again.",
    cancel: "Cancel",
    close: "Close",
    ...
    kycInvalidDocumentTypeSelection: "Please choose which document you're using (CNI or Récépissé).",
  ...
  fr: {
    ...
    startsOn: "Débute le",
    sessionStatusDraft: "En attente du tirage",
    ...
    estimatedDateLabel: "Prévu",
    positionNotYetAssignedShort: "Position pas encore attribuée",
    ...
    payoutClaimStatusSubmitted: "Détails soumis",
    payoutClaimStatusReleased: "Envoyé",
    payoutClaimStatusConfirmed: "Confirmé",
    ...
    title: "Titre",
    sessionTitlePlaceholder: "ex. Cycle du dimanche — Équipe Douala",
    ...
    noBackSideSubmitted: "Aucun verso soumis",
    ...
    orangeMoneyLabel: "Orange Money",
    mtnMobileMoneyLabel: "MTN Mobile Money",
    defaultPayerLabel: "Par défaut",
    useNewPayerNumberAction: "Utiliser un autre numéro",
    savePayerNumberAction: "Enregistrer ce numéro pour les prochains paiements",
    unrecognizedMobileMoneyProvider: "Ce numéro ne correspond à aucune plage Orange Money ou MTN Mobile Money connue.",
    savedPaymentMethodLimitReached: "Vous pouvez enregistrer jusqu'à {max} numéros de paiement.",
    savedPaymentMethodDuplicate: "Ce numéro est déjà enregistré.",
    savedPayerNumbersTitle: "Numéros de paiement enregistrés",
    savedPayerNumbersBody: "Enregistrez vos numéros Orange Money ou MTN Mobile Money pour les réutiliser lors de vos cotisations — visibles uniquement par vous.",
    payerNumberSaved: "Numéro de paiement enregistré.",
    setAsDefaultAction: "Définir par défaut",
    removePayerNumberAction: "Supprimer ce numéro de paiement",
    addPayerNumberAction: "Ajouter",
    ...
    swapDeclined: "Refusé",
    swapCannotRequestSelf: "Vous ne pouvez pas demander un échange avec vous-même.",
    swapMembersMustBelong: "Les deux membres doivent appartenir à cette cotisation.",
    swapAlreadyPending: "Il y a déjà une demande d'échange en attente entre vous deux.",
    swapRequestNotFound: "Cette demande d'échange n'existe plus.",
    swapOnlyTargetCanRespond: "Seul le membre sollicité peut répondre à cette demande.",
    swapAlreadyResolved: "Cette demande a déjà été traitée.",
    ...
    paymentReceivedEmailSubject: "Paiement reçu — {session}",
    paymentSentEmailSubject: "Paiement envoyé — {session}",
    paymentReceivedEmailGreeting: "Bonjour {name},",
    paymentReceivedEmailIntro: "🎉 Votre contribution a été reçue avec succès.",
    thankYouContributionLine: "Merci pour votre contribution à la caisse commune.",
    ...
    documentTypeSelectionLabel: "Quel document souhaitez-vous utiliser ?",
    documentTypeCni: "CNI (Carte Nationale d'Identité)",
    documentTypeRecepisse: "Récépissé",
    cniBothSidesRequired: "Les deux faces de la CNI sont obligatoires.",
    recepisseSingleSideNote: "Le recto est obligatoire. Le verso est optionnel pour un récépissé.",
    documentFrontPhotoLabel: "Recto de votre CNI",
    documentFrontPhotoInstruction: "Prenez une photo nette et bien éclairée du recto de votre CNI. Tout le texte doit être lisible.",
    documentFrontPhotoLabelRecepisse: "Recto de votre récépissé",
    documentFrontPhotoInstructionRecepisse: "Prenez une photo nette et bien éclairée du recto de votre récépissé. Tout le texte doit être lisible.",
    documentBackPhotoLabel: "Verso de votre CNI",
    documentBackPhotoInstruction: "Maintenant le verso de la même CNI.",
    documentBackPhotoLabelRecepisse: "Verso de votre récépissé (optionnel)",
    documentBackPhotoInstructionRecepisse: "Si votre récépissé a un verso imprimé, ajoutez-le ici — sinon vous pouvez passer cette étape.",
    selfiePhotoLabel: "Un selfie de vous",
    selfiePhotoInstruction: "Prenez une photo nette de votre visage — bonne luminosité, sans lunettes de soleil ni masque, regardez droit vers la caméra. Cela doit être vous, et non une photo de la pièce d'identité.",
    kycSubmissionSummary: "Prêt à envoyer : recto + verso de votre CNI, un selfie, et le parrain {referrer}. Un admin examinera tout avant d'approuver votre demande.",
    ...
    kycSessionLookupFailed: "Impossible de charger les détails de cette cotisation. Vérifiez votre connexion et réessayez.",
    kycMembershipCheckFailed: "Impossible de vérifier votre statut d'adhésion. Vérifiez votre connexion et réessayez.",
    kycTransactionFailed: "Vos photos ont été envoyées, mais la soumission n'a pas pu être enregistrée. Veuillez réessayer.",
    cancel: "Annuler",
    close: "Fermer",
    ...
    kycInvalidDocumentTypeSelection: "Veuillez choisir le document que vous utilisez (CNI ou Récépissé).",
